...
void print_op(operation_t *op) {
  switch(op->code) {
    ...
    case OP_DIV:
      ...
      break;
    case OP_ADDI:
      printf("addI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_SUBI:
      printf("subI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_RSUBI:
      printf("rsubI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_MULTI:
      printf("multI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_DIVI:
      printf("divI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_RDIVI:
      printf("rdivI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_LSHIFT:
      printf("lshift r%d, r%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_LSHIFTI:
      printf("lshiftI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_RSHIFT:
      printf("rshift r%d, r%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_RSHIFTI:
      printf("rshiftI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_AND:
      printf("and r%d, r%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_ANDI:
      printf("andI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_OR:
      printf("or r%d, r%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_ORI:
      printf("orI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_XOR:
      printf("xor r%d, r%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_XORI:
      printf("xorI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_LOADI:
      printf("loadI c%d => r%d\n", (op->left_ops)[0], (op->right_ops)[0]);
      break;
    case OP_LOAD:
      printf("load r%d => r%d\n", (op->left_ops)[0], (op->right_ops)[0]);
      break;
    case OP_LOADAI:
      printf("loadAI r%d, c%d => r%d\n", (op->left_ops)[0], (op->left_ops)[1], (op->right_ops)[0]);
      break;
    case OP_LOADA0:
