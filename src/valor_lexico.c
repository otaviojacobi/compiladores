...
void print_type(token_type_t type) {
  ...
  switch(type) {
    ...
    case AST_TYPE_INT: printf("AST_TYPE_INT\n");break;
    case AST_TYPE_FLOAT: printf("AST_TYPE_FLOAT\n");break;
    case AST_TYPE_BOOL: printf("AST_TYPE_BOOL\n");break;
    case AST_TYPE_CHAR: printf("AST_TYPE_CHAR\n");break;
    case AST_TYPE_STRING: printf("AST_TYPE_STRING\n");break;
    case AST_TYPE_FUNCTION_HEAD: printf("AST_TYPE_FUNCTION_HEAD\n");break;
    case AST_TYPE_PARAM: printf("AST_TYPE_PARAM\n");break;
